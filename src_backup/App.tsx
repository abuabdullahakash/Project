...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState<'dashboard' | 'team-dashboard' | 'admin' | 'teams' | 'todos' | 'templates'>('dashboard');
  ...
  const handleNavigate = (view: 'dashboard' | 'team-dashboard' | 'admin' | 'teams' | 'todos' | 'templates', teamId?: string, chat?: boolean) => {
    setCurrentView(view);
    if (teamId) {
      setSelectedTeamId(teamId);
    }

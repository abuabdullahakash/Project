        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className={`relative rounded-2xl shadow-2xl border w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh] ${
              theme === 'dark' ? 'bg-[#020617] border-white/10' : 'bg-white border-gray-200'
            }`}
          >
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-5 scrollbar-thin">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                <div className="space-y-1.5">
                  ...
                  >
                    <option value="High" className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>High</option>
                    <option value="Medium" className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>Medium</option>
                    <option value="Low" className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>Low</option>
                  </select>
                </div>
                <div className="space-y-1.5">
                  ...
                  >
                    <option value="Active" className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>Active</option>
                    <option value="Revision" className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>Revision</option>
                  </select>
                </div>
              </div>
              ...
              {teams.length > 0 && !defaultTeamId && (
                <div className="space-y-1.5">
                  ...
                  >
                    <option value="" className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>No Team</option>
                    {teams.map(team => (
                      <option key={team.id} value={team.id} className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>
                        {team.name}
                      </option>
                    ))}
                  </select>
              ...
              {teamMembers.length > 0 && (
                <div className="space-y-1.5">
                  ...
                  >
                    <option value="" className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>Unassigned</option>
                    {teamMembers.map(member => (
                      <option key={member.uid} value={member.uid} className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>

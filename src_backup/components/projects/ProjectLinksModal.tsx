                      ...
                      {editingLinkId === link.id ? (
                        <div className="flex-1 flex flex-col gap-3">
                          ...
                          <div className="flex justify-end gap-2 mt-1">
                            ...
                            <button onClick={() => saveEditLink(link.id)} className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 text-white rounded-lg text-xs font-medium hover:bg-blue-500 transition-all shadow-lg shadow-blue-500/20"><Check size={14} /> Save</button>
                          </div>
                        </div>
                      ) : (
                        <>
              ...
              {(isAddingCred || editingCredId) && (
                <div className={`p-4 sm:p-5 border rounded-2xl space-y-4 animate-in fade-in slide-in-from-top-4 duration-200 ${
                  ...
                  <div className="flex justify-end gap-2 sm:gap-3 pt-2">
                    ...
                    <button onClick={() => editingCredId ? handleUpdateCred(editingCredId) : handleAddCred()} disabled={!credTitle.trim() || !credUsername.trim()} className="px-4 sm:px-5 py-2 text-[10px] sm:text-sm font-bold uppercase tracking-wider bg-blue-600 text-white rounded-xl hover:bg-blue-500 disabled:opacity-50 transition-all shadow-lg shadow-blue-500/20">

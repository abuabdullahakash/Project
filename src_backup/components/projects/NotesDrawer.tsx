      ...
      {isOpen && project && (
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="flex justify-end gap-2">
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-1 px-2 py-1 bg-blue-600 text-white rounded-lg text-[10px] font-medium hover:bg-blue-500 disabled:opacity-50 transition-all shadow-[0_0_10px_rgba(37,99,235,0.2)]"
                                >
                                  <Check size={10} /> Save
                                </button>
                              </div>
        ...
        <div className={`p-3 sm:p-4 border-t shrink-0 ${
          ...
          <div className="flex gap-2">
            ...
            >
              {CATEGORIES.map(c => (
                <option key={c} value={c} className={theme === 'dark' ? 'bg-[#020617]' : 'bg-white'}>{c}</option>
              ))}
            </select>
            <button
              onClick={handleAddNote}
              className="bg-blue-600 text-white px-4 py-1.5 sm:py-2 rounded-xl text-[9px] sm:text-[11px] font-bold uppercase tracking-[0.1em] hover:bg-blue-500 transition-all shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_20px_rgba(37,99,235,0.5)] whitespace-nowrap"
            >
              Add Note
            </button>
          </div>

                ...
                <div className="space-y-1">
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                    currentView === 'notifier-settings'
                      ? theme === 'dark' ? 'bg-red-500/10 text-red-500 font-semibold border border-red-500/20' : 'bg-red-50 text-red-600 font-semibold border border-red-100'
                      : theme === 'dark' ? 'text-slate-400 hover:text-white hover:bg-white/5' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50'
                  }`}>
                    <Bell size={18} />
                    <span className="text-sm">Notifier Settings</span>
                  </button>

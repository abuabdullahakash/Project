...
export function TeamDashboard({ isSidebarOpen, onSidebarClose, initialTeamId, chatOpenTrigger, onNavigate, onNewProject, onOpenNotes }: TeamDashboardProps) {
  ...
  const teamProjects = projects.filter(p => {
    if (p.projectType === 'personal') return false;
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              {onNewProject && (
                <button
                  ...
                  className="flex-1 sm:flex-none bg-blue-600 hover:bg-blue-500 text-white px-5 py-2.5 rounded-xl font-medium transition-all shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_20px_rgba(37,99,235,0.5)] flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
                >
                  <Plus size={18} />
                  New Project
                </button>

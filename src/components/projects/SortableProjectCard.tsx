...
interface SortableProjectCardProps {
  ...
  onMedia?: (project: Project) => void;
  onUpdate: (project: Project, updates: Partial<Project>) => void;
  onDelete: (project: Project) => void;
  onTouch: (project: Project) => void;
}

export function SortableProjectCard({ project, onEdit, onNotes, onTasks, onLinks, onEmail, onMedia, onUpdate, onDelete, onTouch }: SortableProjectCardProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    <div ref={setNodeRef} style={style} {...attributes} {...listeners} className="touch-none">
      <ProjectCard
        ...
        onOpenMedia={onMedia ? () => onMedia(project) : undefined}

    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="bg-blue-600 text-white px-4 py-2 rounded-xl font-medium hover:bg-blue-500 transition-all flex items-center gap-2 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:scale-105 active:scale-95"
        >
          <Upload size={18} />
          Upload Template
        </button>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="pt-4 flex justify-end gap-3">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-medium text-sm transition-all shadow-[0_0_15px_rgba(37,99,235,0.3)] disabled:opacity-50 flex items-center gap-2 hover:scale-105 active:scale-95"
            >
              {isUploading ? (
                <>
